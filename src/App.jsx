...
function App() {
  ...
  const list1 = [
    ...
    { id: "bar-tailwind", title: "Tailwind CSS", value: "w-1/2" },
    { id: "bar-typescript", title: "Typescript", value: "w-9/12" },
  ];
  const list2 = [
    { id: "bar-laravel", title: "Laravel", value: "w-11/12" },
    { id: "bar-java", title: "Java", value: "w-11/12" },
    { id: "bar-php", title: "PHP", value: "w-4/6" },
    { id: "bar-spring", title: "Spring", value: "w-11/12" },
  ...
  return (
    <div className="container max-w-4xl mx-auto grid grid-cols-5 gap-6 py-4 px-4 lg:px-0">
      ...
      <Blog />
      <Know list={list2} title="BACK-END" />
      {/*  <Hobbies /> */}
      {/* <Experiences /> */}
      <Outlet />
    </div>
